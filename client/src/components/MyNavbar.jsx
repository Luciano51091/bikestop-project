...
const BikeStopLogo = () => (
  <div className="d-flex align-items-center justify-content-center bg-success shadow-sm me-2" style={{ width: "38px", height: "38px", borderRadius: "10px" }}>
...
const MyNavbar = ({ isLoggedIn, handleLogout }) => {
  return (
    <Navbar
      ...
      style={{
        backgroundColor: "rgba(255, 255, 255, 0.95)", // Sfondo bianco quasi opaco
